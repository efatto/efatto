...
_ir_translation_name = 'move.list.xls'


class move_xls_parser(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(move_xls_parser, self).__init__(cr, uid, name, context=context)
...
class move_xls(report_xls):

    def __init__(self, name, table, rml=False, parser=False, header=True,
                 store=False):
        super(move_xls, self).__init__(name, table, rml, parser, header, store)
        ...
        self.col_specs_template = {
            ...
            'name': {
                'header': [1, 42, 'text', _render("_('Account name')")],
                'lines': [1, 0, 'text', _render("line.account_id.name or ''")],
                'totals': [1, 0, 'text', None]},
            'ref': {
...
move_xls('report.move.list.xls',
    'account.move',
    parser=move_xls_parser)

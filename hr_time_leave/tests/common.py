...
class TestHrTimeLeaveBase(common.TransactionCase):

    def setUp(self):
        super(TestHrTimeLeaveBase, self).setUp()
        cr, uid = self.cr, self.uid

        # Usefull models
        self.hr_employee = self.registry('hr.employee')
        self.hr_time_leave = self.registry('hr.time_leave')
        self.hr_time_leave_status = self.registry('hr.time_leave.status')

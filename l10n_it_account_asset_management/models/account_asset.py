...
class account_asset_asset(orm.Model):
    ...
    def _get_depreciation_stop_date(self, cr, uid, asset,
        ...
        if asset.method_number_percent:
            ...
            return super(account_asset_asset, self)._get_depreciation_stop_date(cr, uid, asset,
    ...
    def _compute_year_amount(self, cr, uid, asset, amount_to_depr,
        ...
        if asset.method_number_percent:
            ...
            return super(account_asset_asset, self)._compute_year_amount(
                         cr, uid, asset, amount_to_depr,
                         residual_amount, context=context)

    def _compute_depreciation_table(self, cr, uid, asset, context=None):
        return super(account_asset_asset, self)._compute_depreciation_table(cr, uid, asset, context=context)
#         if not context:
#             context = {}
# 
#         table = []
...
#         return table
    ...
    def _asset_value(self, cr, uid, ids, name, args, context=None):
        return super(account_asset_asset, self)._asset_value(cr, uid, ids, name, args, context=context)

    def _get_assets(self, cr, uid, ids, context=None):
        return super(account_asset_asset, self)._get_assets(cr, uid, ids, context=context)
...
#             if vals.get('method_time') == 'percent':
#                 vals['prorata'] = 0

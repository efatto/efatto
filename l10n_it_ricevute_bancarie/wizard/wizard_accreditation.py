...
class RibaAccreditation(orm.TransientModel):
    ...
    def skip(self, cr, uid, ids, context=None):
        ...
        if context.get('active_model', False) == 'riba.distinta.line':
            ...
            if not active_ids:
                raise orm.except_orm(_('Error'), _('No active IDS found'))
            distinta_line_pool = self.pool.get('riba.distinta.line')
    ...
    def create_move(self, cr, uid, ids, context=None):
        ...
        if context.get('active_model', False) == 'riba.distinta':
            ...
            if (
                not context.get('accruement', False) and
                not distinta.config.accreditation_account_id
            ):
            ...
            'line_id': [
                (0, 0, {
                    ...
                    'account_id': context.get(
                        ...
                        wizard.accreditation_account_id.id,
                ...
                (0, 0, {
                    ...
                    'account_id': context.get(
                        ...
                        wizard.accreditation_account_id.id or
                        wizard.bank_account_id.id,

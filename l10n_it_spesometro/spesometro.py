    ...
    def add_line(self, cr, uid, move, invoice, arg):
        ...
        if not com_line_ids:
            ...
            val = {
                ...
                'pf_codice_stato_estero' : move.partner_id.country_id.codice_stato_agenzia_entrate or '',
                
                'pg_denominazione' : move.partner_id.name or False,
                'pg_citta_estera_sede_legale' : move.partner_id.city or False,
                'pg_codice_stato_estero' : move.partner_id.country_id.codice_stato_agenzia_entrate or '',
                'pg_indirizzo_sede_legale' : move.partner_id.street or False,

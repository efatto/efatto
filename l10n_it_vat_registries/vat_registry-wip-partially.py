    ...
    def _tax_amounts_by_code(self, move):
        ...
        for move_line in move.line_id:
            if (
                ...
                # TODO: verificare se serve: and move_line.tax_amount
            ):
                ...
                if move_line.tax_code_id.is_base:
                    amount = (move_line.tax_amount * self.localcontext['data']['form']['tax_sign'])
        ...
        for move_line in move.line_id:
            ...
            if move_line.tax_code_id and not move_line.tax_code_id.exclude_from_registries:
                ...
                if not move_line.tax_code_id.is_base:
                    #if move_line.tax_code_id.tax_ids: # TODO: ref_tax_ids e tax_ids are created from l10n_it_partially_deductible_vat
                    ...
                    if result.has_key(tax_code.id):
                        ...
                        raise Warning(_("Tax codes malconfigured!"),
    ...
    def _get_tax_lines(self, move):
        ...
        for tax_code_id in amounts_by_code:
            ...
            tax_item = {
                ...
                'base_amount': amounts_by_code[tax_code_id]['base'],
                'index': index,
...
class report_registro_iva_vendite(models.AbstractModel):

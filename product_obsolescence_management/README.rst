...
===============================
Product obsoloscence management
===============================
...
.. |badge3| image:: https://img.shields.io/badge/github-efatto%2Fefatto-lightgray.png?logo=github
    :target: https://github.com/efatto/efatto/tree/14.0/product_obsolescence_management
    :alt: efatto/efatto
...
`feedback <https://github.com/efatto/efatto/issues/new?body=module:%20product_obsolescence_management%0Aversion:%2014.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `efatto/efatto <https://github.com/efatto/efatto/tree/14.0/product_obsolescence_management>`_ project on GitHub.

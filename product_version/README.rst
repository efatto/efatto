...
* the original product
    ...
    * is duplicated [if there is/are bom/s linked, they are updated with new
     product; this boms are versioned too]
    * the clone get only a marker and the same sequence number,

TO DECIDE:
- Block "duplication" with alert before proceed?

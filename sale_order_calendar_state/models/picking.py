...
class Picking(models.Model):
    ...
    is_printed_for_logistics = fields.Boolean(string="Printed for logistic", copy=False)
    ...
    def mark_printed_for_logistic(self):
        self.write({"is_printed_for_logistics": True})

    def unmark_printed_for_logistic(self):
        self.write({"is_printed_for_logistics": False})

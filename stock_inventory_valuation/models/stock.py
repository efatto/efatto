...
class StockInventoryLine(models.Model):
    ...
    valuation_price_unit = fields.Float("Recalculated unit cost")
    valuation_price_subtotal = fields.Float("Recalculated subtotal cost")
...
class StockInventory(models.Model):
                    ...
                    line.write(
                        {
                            ...
                            "valuation_price_subtotal": line.product_id.standard_price
                            * line.product_qty,
                        }
                    )
                    ...
                    line.write(
                        {
                            ...
                            "valuation_price_subtotal": line.product_id.lst_price
                            * line.product_qty,
                        }
                    )
    ...
    def update_tuple(
        self, qty_to_go, product_qty, tuples, move, price_unit, qty_from, older_qty
    ):
